...
{
    public class PageEFRepositoryTests : IClassFixture<IntegrationTestsContext>
    {
        private readonly IntegrationTestsContext _context;

        public PageEFRepositoryTests(IntegrationTestsContext context)
        {
            _context = context;
        }
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [Fact]
        public async Task Get_All_Short_Pages_In_Postgre_Test()
        {
            if(!_context.AllowPostgreSQL)
            {
                Assert.True(true);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [Fact]
        public async Task Get_Short_Portal_Claims_Model_In_Postgre_Test()
        {
            if(!_context.AllowPostgreSQL)
            {
                Assert.True(true);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [Fact]
        public async Task Get_One_By_Name_For_Render_Postgre_Test()
        {
            if(!_context.AllowPostgreSQL)
            {
                Assert.True(true);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [Fact]
        public async Task Get_All_Short_Pages_In_SqlServer_Test()
        {
            if(!_context.AllowSQLServer)
            {
                Assert.True(true);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [Fact]
        public async Task Get_Short_Portal_Claims_Model_In_SqlServer_Test()
        {
            if(!_context.AllowSQLServer)
            {
                Assert.True(true);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [Fact]
        public async Task Get_One_By_Name_For_Render_SqlServer_Test()
        {
            if(!_context.AllowSQLServer)
            {
                Assert.True(true);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [Fact]
        public async Task Get_All_Short_Pages_In_MySql_Test()
        {
            if(!_context.AllowMySQL)
            {
                Assert.True(true);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [Fact]
        public async Task Get_Short_Portal_Claims_Model_In_MySql_Test()
        {
            if(!_context.AllowMySQL)
            {
                Assert.True(true);
...
#pragma warning restore CA2000 // Dispose objects before losing scope
        ...
        [Fact]
        public async Task Get_One_By_Name_For_Render_MySql_Test()
        {
            if(!_context.AllowMySQL)
            {
                Assert.True(true);
