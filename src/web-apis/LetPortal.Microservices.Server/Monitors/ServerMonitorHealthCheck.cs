...
{
    public class ServerMonitorHealthCheck : IHealthCheck
    {
        ...
        private readonly IOptionsMonitor<SelfServerOptions> _serviceOptions;
        private readonly IMonitorHealthCheck _monitorHealthCheck;

        public ServerMonitorHealthCheck(
            ...
            IOptionsMonitor<SelfServerOptions> serviceOptions,
        ...
        public async Task<HealthCheckResult> CheckHealthAsync(HealthCheckContext context, CancellationToken cancellationToken = default)
        {
            ...
            {
                Console.WriteLine("Server had memory usage + " + pushHealthCheckModel.HardwareInfoHealthCheck.MemoryUsed.ToString());
            ...
            {
                { Constants.SERVER_MONITOR_HEALTHCHECK_DATA, pushHealthCheckModel }
            };
