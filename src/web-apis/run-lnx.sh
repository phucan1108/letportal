...
screen -S letportal-sm -p -0 -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
...
screen -S letportal-pt -p -0 -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
...
screen -S letportal-id -p -0 -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
...
screen -S letportal-gw -p -0 -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
