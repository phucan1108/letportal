...
screen -S letportal-sm -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
...
screen -S letportal-pt -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
...
screen -S letportal-id -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
...
screen -S letportal-gw -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
