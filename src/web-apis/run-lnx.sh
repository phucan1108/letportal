...
screen -dmS letportal-sm -p -0 -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
...
screen -dmS letportal-pt -p -0 -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
...
screen -dmS letportal-id -p -0 -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
...
screen -dmS letportal-gw -p -0 -X stuff 'export ASPNETCORE_ENVIRONMENT=Local\n'
