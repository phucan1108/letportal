...
namespace LetPortal.Versions
{
    public class LetPortalVersionDbContext : DbContext
    {
        ...
        public LetPortalVersionDbContext(DatabaseOptions options)
        {
            _options = options;
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var jsonChartDatabaseOptions = new ValueConverter<Portal.Entities.Shared.DatabaseOptions, string>(
                v => ConvertUtil.SerializeObject(v, true),
                v => ConvertUtil.DeserializeObject<Portal.Entities.Shared.DatabaseOptions>(v));
