...
namespace LetPortal.Versions.Identity
{
    public class Identity_0_8_1 : IIdentityVersion
    {
        ...
        {
            var adminRole = await _roleRepository.GetByNameAsync(RolesConstants.ADMIN);
            var developerRole = await _roleRepository.GetByNameAsync(RolesConstants.DEVELOPER);
