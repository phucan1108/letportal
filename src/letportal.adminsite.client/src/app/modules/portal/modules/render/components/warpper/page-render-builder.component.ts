...
export class PageRenderBuilderComponent implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, OnDestroy {
    ...
    actionCommands: ExtendedPageButton[] = []
    isSmallDevice = false
    ...
    ngOnInit(): void {
        ...
        this.sections = ObjectUtils.clone(this.page.builder.sections) as ExtendedPageSection[]
        this.actionCommands = this.page.commands ? this.page.commands.filter(a => !ObjectUtils.isNotNull(a.placeSectionId)) as ExtendedPageButton[] : []
