import { Component, OnInit, ChangeDetectionStrategy, ViewChild, ChangeDetectorRef, OnChanges, SimpleChanges } from '@angular/core';
...
import { CommandModalComponent } from './components/commands/command-dialog.component';
import { DynamicListDataSourceComponent } from './components/dynamic-list.datasource.component';
...
import { ExtendedFilterField, ListOptions } from '../models/extended.model';
import { CommandGridComponent } from './components/commands/command-grid.component';
...
@Component({
    ...
    styleUrls: ['./dynamic-list-builder.component.scss']
})
