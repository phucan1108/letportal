...
import { ExtendedMenu, MenuNode } from 'portal/menu/models/extended.model';
import { App, AppsClient, Menu, MenuProfile } from 'services/portal.service';
...
@Component({
    ...
    templateUrl: './menu-profiles.component.html'
})
export class MenuProfilesComponent implements OnInit {
    @ViewChild('menuTree')
